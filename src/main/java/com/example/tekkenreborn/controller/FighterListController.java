...
import com.example.tekkenreborn.model.dto.FighterSearchByDateDto;
import com.example.tekkenreborn.repository.FighterRepository;
import com.example.tekkenreborn.repository.FighterRepositoryPaginated;
...
public class FighterListController {
    ...
    @PostMapping
    public String searchFightersByDate(@ModelAttribute FighterSearchByDateDto fightersByDateDto, Model model) {
